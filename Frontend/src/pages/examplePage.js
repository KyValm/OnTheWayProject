...
class ExamplePage extends BaseClass {
    ...
    constructor() {
        super();
        this.bindClassMethods(['onUpdateSubmit','onGetPriorityItems', 'onGetAllItems', 'renderItems', 'onGetItemById','onGetItemsByCategory'], this);
    ...
    mount() {
        ...
        document.getElementById('update-btn-submit').addEventListener('submit', this.onUpdateSubmit);
    ...
    async onUpdateSubmit(event) {
        ...
        const itemId = document.getElementById('item-title-update').value;
        const description = document.getElementById('description-update').value;
        const currentQty = document.getElementById('current-update').value;
        const reorderQty = document.getElementById('reorder-update').value;
        const triggerQty = document.getElementById('trigger-update').value;
        const orderDate = document.getElementById('orderDate-update').value;

        await this.client.updateItem(itemId, description, currentQty, reorderQty, triggerQty, orderDate);
